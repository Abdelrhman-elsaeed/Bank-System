...
private:
    ...
    static void _PrintTransferLogRecordLine(clsBankClient::stTransferLog TransferLogRecord)
    {
        ...
        cout << "| " << setw(8) << left << TransferLogRecord.SourceAccountNumbr;
        cout << "| " << setw(8) << left << TransferLogRecord.DistAccountNumbr;
        cout << "| " << setw(8) << left << TransferLogRecord.amount;
        cout << "| " << setw(10) << left << TransferLogRecord.SourceAccountBalance;
        cout << "| " << setw(10) << left << TransferLogRecord.DistAccountBalance;
...
public:
    ...
    static void ShowTransferLogScreen()
    {
        ...
        if (vTransferLogRecord.size() == 0)
            ...
            for (clsBankClient::stTransferLog &C : vTransferLogRecord)
            {
