...
private:
    ...
    static void _PerformManageUsersMenueOption(_enManageUsersMenueOptions ManageUsersMenueOption)
    {
...
public:
	...
	static void ShowManageUsersMenue()
	{
        if (!CheckAccessRights(clsUser::enPermissions::pManageUsers))
        {
			...
			_PerformManageUsersMenueOption((_enManageUsersMenueOptions)ReadManageUsersMenueOption());
